			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="beta-products-list">
						...
						<div class="row">
							@foreach($sanphamkh as $kh)
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{ route('chitietsanpham',$kh->id) }}"><img src="source/image/product/{{ $kh->image }}" alt="" height=250px></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{ $kh->name }}</p>
											<p class="single-item-price">
												<span class="flash-del">{{number_format( $kh->unit_price )}} VND</span>	
												<span class="flash-sale">{{number_format( $kh->promotion_price )}} VND</span>
											</p>
										</div>
										<div class="single-item-caption">
